...
public class Vector3D {
  ...
  public static Vector3D operator *(double lhs, Vector3D rhs) => rhs * lhs;
  ...
  private static double ComputeLength(Vector3D vector3D) =>
      Math.Sqrt(vector3D.X * vector3D.X + vector3D.Y * vector3D.Y +
  ...
  private void ResetLength() { _length = null; }
}
}
