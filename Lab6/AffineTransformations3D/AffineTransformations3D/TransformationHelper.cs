...
public static class TransformationHelper {
  public static void ApplyTransformationInplace(Polyhedron polyhedron,
  ...
  public static void TransformMultiplePointsInplace(List<Point3D> points,
                                                    Matrix transformation) =>
      points.ForEach(p => TransformPointInplace(p, transformation));

  public static void TransformPointInplace(Point3D point,
                                           Matrix transformation) {
