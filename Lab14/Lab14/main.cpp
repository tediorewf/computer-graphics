...
void Draw() {
  ...
  glUniform3f(glGetUniformLocation(Program, "pointLight.position"),
              pointLightPositionX, pointLightPositionY, pointLightPositionZ);
  ...
  glUniform1f(glGetUniformLocation(Program, "pointLight.quadratic"),
              0.000000027f);
  ...
  modelBanana2 = glm::rotate(modelBanana2, glm::radians(47.0f),
                             glm::vec3(0.0f, 0.0f, 1.0f));
