...
#region Код, автоматически созданный конструктором форм Windows
  ...
  private void InitializeComponent() {
    ...
    ((System.ComponentModel.ISupportInitialize)(this.cornishRoomPictureBox))
        .BeginInit();
    this.SuspendLayout();
    //
    // cornishRoomPictureBox
    //
    this.cornishRoomPictureBox.BackColor =
    ...
    this.xCameraPositionTextBox.TextAlign =
    ...
    this.zCameraPositionTextBox.TextAlign =
        System.Windows.Forms.HorizontalAlignment.Center;
    //
    ...
    this.yCameraPositionTextBox.TextAlign =
        System.Windows.Forms.HorizontalAlignment.Center;
    //
    // MainForm
    //
