...
#region Windows Form Designer generated code
  ...
  private void InitializeComponent() {
    ...
    ((System.ComponentModel.ISupportInitialize)(this.trianglePictureBox))
        .BeginInit();
    this.SuspendLayout();
    //
    // addVerticesButton
    ...
    //
    this.performRasterizationButton.Location =
        new System.Drawing.Point(772, 12);
    ...
    this.trianglePictureBox.MouseClick +=
        new System.Windows.Forms.MouseEventHandler(
            this.trianglePictureBox_MouseClick);
    this.trianglePictureBox.MouseLeave +=
        new System.EventHandler(this.trianglePictureBox_MouseLeave);
    this.trianglePictureBox.MouseMove +=
        new System.Windows.Forms.MouseEventHandler(
            this.trianglePictureBox_MouseMove);
    //
    ...
    this.removeVerticesButton.Click +=
        new System.EventHandler(this.removeVerticesButton_Click);
    //
    // Task3Form
    //
