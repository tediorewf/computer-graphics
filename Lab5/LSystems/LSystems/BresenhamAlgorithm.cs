...
public static class BresenhamAlgorithm {
  ...
  public static void DrawBresenhamLineSafely(this Bitmap drawingSurface,
  ...
  public static void DrawBresenhamLineSafely(this FastBitmap fastDrawingSurface,
                                             Point p1, Point p2, Color color) {
    fastDrawingSurface.DrawPointsSafely(GetBresenhamPoints(p1, p2), color);
  }

  public static void DrawPointsSafely(this FastBitmap fastDrawingSurface,
  ...
  public static bool IsPointOnSurface(this FastBitmap fastDrawingSurface,
                                      Point p) {
