...
public static class MidpointDisplacementAlgorithm {
  public static IEnumerable<List<Edge>>
  GetMidpointDisplacementEdgesStepByStep(Point begin, Point end,
  ...
  private static Point CalculateMidPoint(Edge edge, double roughness,
                                         Random random) {
